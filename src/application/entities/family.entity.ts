...
export class Family {
  ...
  @Column({ name: 'father_first_name', length: 100, nullable: true })
  fatherFirstName?: string;

  @Column({ name: 'father_surname', length: 100, nullable: true })
  fatherSurname?: string;

  @Column({ name: 'father_national_id', length: 50, nullable: true })
  fatherNationalId?: string;

  @Column({ name: 'father_phone', length: 30, nullable: true })
  fatherPhone?: string;

  @Column({ name: 'father_profession', length: 150, nullable: true })
  fatherProfession?: string;

  @Column({ name: 'father_monthly_income', type: 'decimal', precision: 12, scale: 2, nullable: true })
  fatherMonthlyIncome?: number;

  @Column({ name: 'father_ta', length: 100, nullable: true })
  fatherTa?: string;
  ...
  @Column({ name: 'mother_first_name', length: 100, nullable: true })
  motherFirstName?: string;

  @Column({ name: 'mother_surname', length: 100, nullable: true })
  motherSurname?: string;

  @Column({ name: 'mother_national_id', length: 50, nullable: true })
  motherNationalId?: string;

  @Column({ name: 'mother_phone', length: 30, nullable: true })
  motherPhone?: string;

  @Column({ name: 'mother_profession', length: 150, nullable: true })
  motherProfession?: string;

  @Column({ name: 'mother_monthly_income', type: 'decimal', precision: 12, scale: 2, nullable: true })
  motherMonthlyIncome?: number;

  @Column({ name: 'mother_ta', length: 100, nullable: true })
  motherTa?: string;
  ...
  @Column({ name: 'parent_first_name', length: 100, nullable: true })
  parentFirstName?: string;

  @Column({ name: 'parent_surname', length: 100, nullable: true })
  parentSurname?: string;

  @Column({ name: 'parent_national_id', length: 50, nullable: true })
  parentNationalId?: string;

  @Column({ name: 'parent_phone', length: 30, nullable: true })
  parentPhone?: string;

  @Column({ name: 'parent_monthly_income', type: 'decimal', precision: 12, scale: 2, nullable: true })
  parentMonthlyIncome?: number;

  @Column({ name: 'student_relationship', length: 50, nullable: true })
  studentRelationship?: string;

  @Column({ name: 'parent_ta', length: 100, nullable: true })
  parentTa?: string;
  ...
  @Column({ name: 'guardian_first_name', length: 100, nullable: true })
  guardianFirstName?: string;

  @Column({ name: 'guardian_last_name', length: 100, nullable: true })
  guardianLastName?: string;

  @Column({ name: 'guardian_national_id', length: 50, nullable: true })
  ...
  @Column({ name: 'relationship_to_guardian', length: 100, nullable: true })
  relationshipToGuardian?: string;

  @Column({ name: 'guardian_ta', length: 100, nullable: true })
  guardianTa?: string;
  ...
  @Column({ name: 'deceased_father_id', length: 50, nullable: true })
  deceasedFatherId?: string;

  @Column({ name: 'deceased_mother_id', length: 50, nullable: true })
